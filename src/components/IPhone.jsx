...
export default function Iphone(props) {
  ...
  //console.log("materials", Object.entries(materials));
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh
        ...
        scale={0.01}
      >
        {/*in this material, texture have to be applied to change the scene color 
        of the mobile screen color in the 3d model */}
